...
public class ItemModel {
    ...
    private String perfered_supplier;
    ...
    public String getPerfered_supplier() {
        return perfered_supplier;
    }

    public void setPerfered_supplier(String perfered_supplier) {
        this.perfered_supplier = perfered_supplier;
    }
