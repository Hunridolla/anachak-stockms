...
import lasolutions.stockmanagement.Vendor.VendorService;
...
public class VendorController {
    ...
    @Autowired
    public VendorController(VendorService vendorService, VendorRepository vendorRepository, VendorTypeRepository vendorTypeRepository) {
    ...
    public ResponseEntity<Object> saveVendor(
        ...
        return new ResponseEntity<>(vendorRepository.getVendors(), HttpStatus.OK);
    }
